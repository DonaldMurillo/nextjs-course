...
Global styles set the foundation for your application—resets, base typography, CSS variables, and shared utilities. This chapter covers organizing your styles for maintainability and performance.
...
├── reset.css          # CSS reset (if not using Tailwind)
...
- Organize styles: variables → reset → base → components → utilities
...
**Next Chapter:** [10. Images, Fonts & Metadata](./10-images-fonts-metadata.md) - Optimize media assets and SEO.
